...
void initalTags(pcl::PointCloud<pcl::PointXYZRGB>::Ptr old_cloud, pcl::PointCloud<pcl::PointXYZRGB>::Ptr new_cloud, Eigen::Matrix4f mc, Eigen::Matrix4f tr,int xres,int yres,float coeffx,float coeffy, float dthresh, int* oldTags, int* newTags);
#endif